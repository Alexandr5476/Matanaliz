...
\begin{lem}[https://www.youtube.com/live/oGN0SkfpZME?si=v9AomZJHSzhlMvMm&t=10556]{или следующий пункт замечания}
...
\begin{teor}[https://www.youtube.com/live/oGN0SkfpZME?si=rzyEi2Hd6nOeRw-i&t=11638]{Стокса-Зайдля}
	Функция $f$ и последовательность функций $f_n$ действуют $X \to \rr$, где $X$ --- метрическое пространство. Пусть все функции из последовательнсти непрерывны в точке $c \in X$ и\begin{tikzcd}
		f_n \ar[yshift=2pt]{r}{X}
		\ar[yshift=-2pt]{r}[swap]{n \to \infty} & f
	\end{tikzcd}\!. Тогда $f$ непрервна в точке $c$.
\end{teor} % Конец доказательства теоремы Стокса-Зайдля
