...
\begin{lem}[https://www.youtube.com/live/oWtiSJdhQV8?si=ldUCi49yVsxTBWWR&t=7819]{о дифференцировании <<сдвига>>} \label{лем. для форм. тейл.}
	$E \subset \rmm$, $f \in C^r(E)$ \uns{($f \colon E \to \rr$)}, $a \in \Int E$. 
...
\begin{teor}[https://www.youtube.com/live/oWtiSJdhQV8?si=fe296ectftwZMums&t=8945]{формула Тейлора c остатком в форме Лагранжа}[Многомерная формула Тейлора]\label{фор.тейл.,ост.в форм.лагр.}\add*{Формула Тейлора (различные виды записи)}%
	Пусть $E \subset \rmm$, \uns{($f \colon E \to \rr$)} $f \in C^{r + 1}(E)$, \uns{точка $a \in \Int E$, $R \in \rr : \B{a, R} \subset E$,} $x \in \B{a, R}$, $h = x - a$, тогда$\E \theta \in (0, 1)$ такое, что:
...
\begin{opr}\label{опр:дифференциал}\add*{$n$-ый дифференциал}
	...
	называется
	\urlybox{https://www.youtube.com/live/oWtiSJdhQV8?si=im2RytH_7KDpHR2U&t=10235}{$n$-ым дифференциалом}
	функции $f$ в точке $a$.
