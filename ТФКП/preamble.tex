...
\newcommand{\uns}[1]{\hypersetup{linkcolor=mygray}\textcolor[rgb]{0.52,0.52,0.52}{#1}\hypersetup{linkcolor=linkcolor}}
...
\newcommand*{\rpr}[2]{\fboxsep=2pt\fbox{\raisebox{-.5pt}[7pt][0pt]{\ensuremath{\hspace{-.5pt}#1\Rightarrow#2}}}}
\newcommand*{\lpr}[2]{\fboxsep=2pt\fbox{\raisebox{-.5pt}[7pt][0pt]{\ensuremath{\hspace{-.5pt}#1\Leftarrow#2}}}}
\newcommand*{\rmm}{\ensuremath{\mathbb R^m}}
\newcommand*{\vp}[2][]{\ensuremath{\big|_{#2}^{#1}}}
\newcommand*{\su}[1]{\raisebox{-4.5pt}{\ensuremath{\Big|_{#1}\!\!\!\!}}}
...
\newcommand{\m}{\ensuremath{\mathcal{M}^m}}
\newcommand{\sct}{\ensuremath{{}^\complement}}
\newcommand{\notar}[1]{\ensuremath{\makebox[0pt]{\hspace{25pt}\ensuremath{\not}} \xrightarrow[#1]{}}}
...
\shirina=\textwidth% Присваеваем в \shirina 90% от ширины текста
...
\newcounter{nform}
\setcounter{nteor}{2}
\renewcommand{\thenteor}{\textcolor[rgb]{0, 0.902, 0}{\arabic{nteor}}\quad}
\renewcommand{\thenform}{\textcolor[rgb]{1, 0.62, 0}{\arabic{nform}}\quad}
\NewDocumentCommand{\add}{s m}{\IfBooleanTF{#1}
{\refstepcounter{nform}\addcontentsline{toc}{subsection}{\thenform #2}}
{\refstepcounter{nteor}\addcontentsline{toc}{subsection}{\thenteor #2}}}

\newcounter{teor} % Создание нового счётчика teor
\NewDocumentEnvironment{teor}{o m o s}{% Создание нового окружения teor (для теорем)
	\IfBooleanF{#4}{% Если нет звёздочки, то добавляем в оглавление
	\refstepcounter{nteor}%
	\IfNoValueTF{#3}{% Если нет третьего аргумента
		\addcontentsline{toc}{subsection}{\thenteor Теорема #2}}%
	{% Если есть третий агрумент
		\addcontentsline{toc}{subsection}{\thenteor #3}}}%
...
\NewDocumentEnvironment{lem}{o m o s}{% Создание нового окружения teor (для теорем)
	\IfBooleanF{#4}{% Если нет звёздочки, то добавляем в оглавление
		\refstepcounter{nteor}
		\IfNoValueTF{#3}{% Если нет третьего аргумента
			\addcontentsline{toc}{subsection}{\thenteor Лемма #2}}
		{% Если есть третий агрумент
			\addcontentsline{toc}{subsection}{\thenteor #3}}}
